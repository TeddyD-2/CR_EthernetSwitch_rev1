...
// Pulls STM32duino LwIP into Arduino's include path. Arduino resolves
// top-level `#include <Name.h>` by matching a library folder — without this,
// sketches get "lwip/ip_addr.h: No such file or directory" because the
// quoted include in utility/stm32_eth.h is not a library trigger.
#include <LwIP.h>
